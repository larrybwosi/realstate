  ...
  return (
    <div className="grid gap-8 md:grid-cols-2">
      ...
      <div>
        ...
        <p className="text-2xl font-bold text-primary mb-4">${apartment.price.toLocaleString()}/mo</p>
        <div className="flex flex-wrap gap-2 mb-4">
          ...
          <Badge variant="secondary" className="flex items-center gap-1">
            ...
            {apartment.parkingSpaces} Parking {apartment.parkingSpaces === 1 ? 'Space' : 'Spaces'}
          </Badge>
        ...
        <p className="mb-4">
          This apartment is located in {apartment.court.name}. Floor: {apartment.floorNumber}, 

      ...
      <CardHeader>
        <div className="flex items-center justify-between">
          ...
          <span className="px-3 py-1 bg-green-100 dark:bg-green-900/30 text-green-700 dark:text-green-400 text-sm rounded-full">
            Available {new Date(details.availableDate).toLocaleDateString()}
          </span>
        </div>
      ...
      <CardContent>
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-2 gap-4">
            {[
              { icon: BedDouble, label: 'Bedrooms', value: details.bedrooms },
              { icon: Bath, label: 'Bathrooms', value: details.bathrooms },
              { icon: Maximize, label: 'Square Footage', value: `${details.squareFootage} sq ft` },
          ...
          <div className="text-center">
            <span className="text-3xl font-bold text-blue-600 dark:text-blue-400">${details.price}</span>
